...
**Dog Bot** — это бот для Discord, который генерирует случайные картинки собак и делится интересными фактами о них.
...
![dog_image_example](images/example_image.png)

*Факт о собаке: Собаки могут слышать звуки на частотах до 65 000 Гц.*
